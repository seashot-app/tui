...
const rightRange = filterMenu.range.slice(
  Math.floor(filterMenu.range.length / 2),
  filterMenu.range.length
);
        ...
        ${filterMenu.color
          .map(
            ...
            <div class="filter-color-item">
                <div class="tie-${toKebabCase(type)}-color" title="${locale.localize(
              getFilterName(type)
            )}"></div>
                <div class="tui-image-editor-checkbox">
                    <label>
